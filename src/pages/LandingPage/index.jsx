...
//SORRY COULDNT MAKE IT PiXEL PERFECT AS I HAVE EXAMS  
      ...
      <div className="w-full overflow-auto bg-white-A700 shadow-lg">
        <header className="p-[11px] bg-white-A700 shadow-md ">
          <div className="w-full mx-auto md:p-5 max-w-[801px]  flex gap-9 ">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-col items-center w-full gap-2 mx-auto md:p-5 max-w-[772px]">
              <Heading
                size="lg"
                as="h2"
                className="text-center !text-[25.06px]"
              >
                Our Clients
              </Heading>
            ...
            <Img
              ...
              alt="clientslogos"
              className="h-[px] w-full mx-auto md:p-5 max-w-[1201px]"
            />
          </div>
          <div className="flex flex-col gap-[11px]">
            <div className="flex flex-col items-center pb-0.5 gap-1.5">
              <Heading
                size="lg"
                as="h2"
                className="w-[28%] md:w-full text-center !text-[30.06px]"
              >
          ...
          <div>
            <div className="flex md:flex-col justify-center items-center gap-[34px]">
              <Img
                ...
                alt="image"
                className="h-[301px] md:w-full"
              />
              <div className="flex flex-col items-start w-[48%] md:w-full gap-[22px]">
                <div className="flex flex-col w-[91%] md:w-full gap-[11px]">
                  <Heading size="lg" as="h2" className="!text-[25.06px] font-bold w-[50%]">
                    The unseen of spending three years at Pixelgrade
                  </Heading>
                  <Text size="s" as="p" className="!text-[10.74px] w-[60%]">
          ...
          <div className="flex md:flex-col justify-between items-center gap-5 p-11 md:p-5 bg-gray-100_01">
            <div className="flex flex-col items-start w-[47%] md:w-full ml-[55px] pb-0.5 gap-1.5">
              <Heading
                size="lg"
                as="h2"
                className="flex flex-col w-[76%] md:w-full !text-[25.06px]"
              >
            ...
            <div className="w-[47%] md:w-full mr-[300px]">
              <div className="justify-center gap-8 grid-cols-2 md:grid-cols-[1fr] grid">
            ...
            <div className="flex md:flex-col justify-between items-center pt-[3px] gap-5 px-[3px]">
              ...
              <div className="flex flex-col items-start w-[60%] md:w-full mr-24 gap-[22px]">
                <div className="flex flex-col w-[91%] md:w-full gap-[11px]">
                  ...
                  <Text size="s" as="p" className="!text-[10.74px] w-[50%] ">
          ...
          <div className="flex flex-col gap-[11px]">
            <div className="flex flex-col items-center w-full gap-[3px] mx-auto md:p-5 max-w-[772px]">
              ...
              <Text
                size="md"
                as="p"
                className="w-[57%] md:w-full text-center !text-[11.14px] !leading-4"
              >
              ...
              <div className="flex justify-center w-full">
                <div className="flex flex-col items-center w-full">
                  ...
                  <div className="flex flex-col items-center w-[86%] md:w-full mt-[-66px] gap-[11px] p-[11px] bg-gray-100_01 shadow-xs rounded-[5px]">
                    <Heading
                      as="h3"
                      className="!text-gray-600 text-center !text-[13.92px] !leading-[19px]"
                    >
                    ...
                    <div className="flex justify-center items-center gap-[5px] p-[7px]">
                      <Heading
                        as="h4"
                        className="!text-green-500 !text-[13.92px]"
                      >
                        Readmore
                      </Heading>
                      <Img
        ...
        <div className="mt-[61px]">
          ...
          <footer className="p-11 md:p-5 bg-blue_gray-900_01">
            <div className="flex md:flex-col justify-between items-center w-full  mx-auto md:p-5 max-w-[772px]">
              <div className="flex flex-col items-start w-[32%] md:w-full gap-[37px]">
                <div className="flex flex-col items-start gap-0.5 mr-46 ">
